About lua-language-server-feedstock
===================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lua-language-server-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lua-language-server-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `lua-language-server` available on your platform:
...
```
pixi search lua-language-server --channel conda-forge
```
